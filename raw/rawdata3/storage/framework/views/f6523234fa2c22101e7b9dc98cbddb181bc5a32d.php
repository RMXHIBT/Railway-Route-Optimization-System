...
<body>
     ...
     <br><br><br>
          ...
          <div class="vertical-center">
            ...
            <form name="uac" action="<?php echo e(url('/')); ?>/new_Account" method="POST">
           ...
           <center><label for="gender"><font color="cyan" style = "font-size: 18px;">Select gender :</font></label>
            <select name="type" id="gen" style = "font-size: 18pt; color: orange;">
            <option value="    ">        </option>
            ...
            <input type="password" name="password" style = "font-size:11pt; height: 23px;"></center>

            <br><br>

            <center><label for="pass"><font color="orange" style = "font-size: 18px;">Confirm new Password :
            </font></label>
            <input type="password" name="password_confirmation" style = "font-size:11pt; height: 23px;"></center>
...
</html><?php /**PATH C:\Users\Jeet\my_first_webapp\resources\views/ucreate.blade.php ENDPATH**/ ?>